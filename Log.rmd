...
packages <- c("ggplot2", "tidyr", "dplyr", "readr", "gt")
...
### Manipulate the data
A lot of the rows contain empty strings instead of NA, so set them to NA first. Besides that, the columns `sample_id`, `benign_sample_diagnosis` and `stage` in the dataset are not valuable for the analysis and are therefor dropped.
